...
//	 ④ main() 메소드에서 두 가지 생성자를 이용해서 인스턴스 생성하고 출력 메소드를 통해 저장된 데이터 출력
	...
	// 생성자 (자동 생성) - 모든 정보
	public Member_t(String name, String phoneNumber, String major, int grade, String email, int birthday,
			String address)
	{
	...
	public Member_t(String name, String phoneNumber, String major, int grade, String email)
	{

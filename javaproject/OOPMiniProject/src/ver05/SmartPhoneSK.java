...
public class SmartPhoneSK {
	...
	private static SmartPhoneSK sp = new SmartPhoneSK(10); // 10개까지 입력 가능
	...
	void editContact() {
		...
		if (contact instanceof CompanyContactSK) {

			CompanyContactSK companyContact = (CompanyContactSK) contact;
		...
		} else if (contact instanceof CustomerContactSK) {

			CustomerContactSK customerContact = (CustomerContactSK) contact;

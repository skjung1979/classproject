...
alter table tbl_attach add constraint fk_attach_board_idx foreign key (board_idx) references tbl_board(bno);
...
update tbl_board set photo=concat(photo, ' / ', '999') where bno=243;
